---
name: knowledge-initialization
description: Establish or extend repository and workspace knowledge baselines using evidence-driven initialization
---

# Knowledge initialization

Use this skill for repository-scoped or workspace-level knowledge initialization.
It owns the initialization workflow, including scope selection, resumability,
evidence acquisition, repository coverage reconciliation, repository-local
analysis and workspace reconciliation.

The invoking command supplies the optional repository scope through its command
arguments. Apply the workflow contract below exactly; shared evidence,
persistence and coverage invariants remain owned by `knowledge-generation` and
the dedicated knowledge tools referenced by this workflow.
